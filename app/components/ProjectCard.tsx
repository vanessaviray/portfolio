...
export function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-[88%] lg:w-[42.74%] h-[180px] lg:h-[450px] bg-customColor-lightGray2 mt-[51px] lg:mt-0 rounded-t-[15px] ${isOdd ? "lg:rounded-r-[30px] lg:rounded-l-[0px]" : "lg:rounded-r-[0px] lg:rounded-l-[30px]"}`}
      ></div>
    </div>
  );
}
